...
{
    /* c_packet_header */
    uint32_t mLen;              /* total packet length*/
    uint32_t mType;             /* VNSPACKET */
    char     mInterfaceName[16];
    /* sr_ethernet_hdr */
    uint8_t  ether_dhost[6];  /* dest ethernet addr */
    uint8_t  ether_shost[6];  /* src ethernet addr*/
...
typedef struct
{
    uint32_t mLen;                  /* total packet length*/
    uint32_t mType;                 /* VNSPACKET */
    char     mInterfaceName[16];    /* interface name*/
